...
--
-- Host: localhost    Database: pentool
-- ------------------------------------------------------
...
CREATE TABLE `scans` (
  ...
  PRIMARY KEY (`id`),
  KEY `scans_ibfk_1` (`target_id`),
  CONSTRAINT `scans_ibfk_1` FOREIGN KEY (`target_id`) REFERENCES `targets` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-09-16 18:17:32
